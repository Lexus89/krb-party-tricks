...
def build_as_req(target_realm, user_name, key, current_time, nonce, pac_request=None, padata_type=2):
    ...
    # no preauth = 149, preauth = 2
    #as_req['padata'][0]['padata-type'] = 149 
    #as_req['padata'][0]['padata-value'] = encode(pa_ts)
    #as_req['padata'][0]['padata-type'] = 2
    as_req['padata'][0]['padata-type'] = padata_type
    as_req['padata'][0]['padata-value'] = encode(pa_ts)
